...
function genThemes(b) {
  ...
  var sys = [
    ...
    '朝にふさわしい、やわらかく前向きなトーンで。詰問・断罪・煽りは避け、自然と書きたくなる問いにする。',
    '',
    '良い問いの条件:',
    '- 具体的で、その場ですぐ書き始められる',
    '- 自分の本音にそっと触れる（責めずに、気づきを促す）',
    '- 前向きで、書いたあと少し気持ちが整う・元気が出る',
    '- 完全に自分ごと（一般論やYes/Noで終わる問いは禁止）',
    '- 抽象的すぎず、かといって浅すぎない',
    '- 語尾は「〜は何か」「〜どうしたいか」「〜できると良いか」等の開かれた問い',
    '',
    '良い問いの例（この水準・このやわらかいトーンを真似る）:',
    '- 今日を少し良い一日にするために、まず何から始めたいか',
    '- 最近、心が少し動いた瞬間はいつで、何に惹かれたのか',
    '- 5年後、どんな自分だったら「いいな」と思えるか',
    '- 今の自分が大事にしたいことを3つ挙げると何か',
    '- 手放したら、もっと身軽になれそうなことは何か',
    '',
    '避けたい問いの例（理由つき。絶対に作らない）:',
    '- 「5年後の自分が怒る今の逃げは何か」… 朝から責めるトーンで重すぎる',
    '- 「あなたは今幸せですか？」… Yes/Noで終わり、深く掘れない',
    '- 「成長するにはどうすればいい？」… 主語が大きすぎ・抽象的で書き出せない',
    '- 「もっと努力すべきではないか」… 説教くさく、問いが閉じている',
    '',
