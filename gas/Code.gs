...
function genThemes(b) {
  ...
  var sys = [
    ...
    '',
    '良い問いの例（この水準・このトーンを真似る）:',
    '- 「忙しい」を盾に、本当は向き合いたくないだけの仕事はどれか',
    '- いま一番見て見ぬふりをしている問題は何か、なぜ放置できているのか',
    '- 5年後に後悔しないために、今週きっぱりやめるべきことは何か',
    '- 人の期待に応えようとして、押し殺している本音は何か',
    '- 理想の一日を時間割で書くと、現実と最もズレているのはどこか',
    '',
    '避けたい問いの例（理由つき。絶対に作らない）:',
    '- 「成長するにはどうすればいい？」… 主語が大きすぎ・抽象的で書き出せない',
    '- 「あなたは今幸せですか？」… Yes/Noで終わり、深く掘れない',
    '- 「人生で大切なものは何だと思いますか？」… 評論・一般論になりやすい',
